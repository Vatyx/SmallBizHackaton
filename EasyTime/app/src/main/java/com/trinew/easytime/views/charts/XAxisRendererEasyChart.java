 ...
 */
public class XAxisRendererEasyChart extends XAxisRenderer {

    protected EasyChart mChart;

    public XAxisRendererEasyChart(ViewPortHandler viewPortHandler, XAxis xAxis, Transformer trans,
                                 EasyChart chart) {
